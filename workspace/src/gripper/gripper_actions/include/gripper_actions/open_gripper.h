#ifndef OPEN_GRIPPER_H_
#define OPEN_GRIPPER_H_
...
namespace gripper {
    ...
    class OpenGripper : public BT::SyncActionNode, public rclcpp::Node {
    public:
        OpenGripper(const std::string& name) : BT::SyncActionNode(name, {}), rclcpp::Node("open_gripper") {
