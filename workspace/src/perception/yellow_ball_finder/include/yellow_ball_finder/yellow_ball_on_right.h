#ifndef YELLOW_BALL_ON_RIGHT_H_
#define YELLOW_BALL_ON_RIGHT_H_
...
class YellowBallOnRight : public BT::ConditionNode {
public:
    YellowBallOnRight(const std::string& name, const BT::NodeConfiguration& config) : BT::ConditionNode(name, config) {}
