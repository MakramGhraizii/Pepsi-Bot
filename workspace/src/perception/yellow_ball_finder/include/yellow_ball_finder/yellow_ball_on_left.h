#ifndef YELLOW_BALL_ON_LEFT_H_
#define YELLOW_BALL_ON_LEFT_H_
...
class YellowBallOnLeft : public BT::ConditionNode {
public:
    YellowBallOnLeft(const std::string& name, const BT::NodeConfiguration& config) : BT::ConditionNode(name, config) {}
