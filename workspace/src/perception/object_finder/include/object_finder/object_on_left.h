#ifndef OBJECT_ON_LEFT_H_
#define OBJECT_ON_LEFT_H_

#include <behaviortree_cpp_v3/behavior_tree.h>
#include <rclcpp/rclcpp.hpp>

namespace perception {
    // Condition Node to check if the object is on the left
    class ObjectOnLeft : public BT::ConditionNode {
    public:
        ObjectOnLeft(const std::string& name, const BT::NodeConfiguration& config) : BT::ConditionNode(name, config) {}
